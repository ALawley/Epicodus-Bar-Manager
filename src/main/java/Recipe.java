...
public class Recipe {
  ...
  public void save() {
    String sql = "INSERT INTO  recipes (name, notes, creator, prep_time, directions) VALUES (:name, :notes, :creator, :prep_time, :directions);";
    try (Connection con = DB.sql2o.open()) {
  ...
  public void clearIngredients() {
    String sql = "DELETE FROM ingredients WHERE recipe_id=:recipe_id;";
    try (Connection con = DB.sql2o.open()) {
      con.createQuery(sql)
      .addParameter("recipe_id", this.getId())
      .executeUpdate();
